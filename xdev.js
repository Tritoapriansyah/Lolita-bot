...
offline = false
targetpc = '0'
ownerNumber = ["6283818744065@s.whatsapp.net","6283818744065@s.whatsapp.net","6283818744065@s.whatsapp.net","6285624553262@s.whatsapp.net"]
fake = 'ɪ ᴀᴍ ndyie'
fake1 = '_*© 𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 ndyie*_'
numbernye = '0'
waktu = '-'
alasan = '-'
...
if (button == '🔍 NEKOPOI') {
console.log('YOUTUBE')
xdev.sendMessage(from, `*Subscribe Chanel Owner Ya*\n_https://youtube.com/channel/UCMrNJ3KTUaj9nscXKwGqNZw_`, text, {quoted: dev})
}
if (budy.startsWith('$')){
if (!dev.key.fromMe && !isOwner) return
qur = budy.slice(2)
